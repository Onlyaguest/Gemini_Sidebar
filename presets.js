    ...
    items: [
      {
        ...
        label: "第一性原理拆解",
        template:
          "不要列一二三，直接从第一性原理帮我看我刚才说的内容，判断我大概率的原因是什么，有什么可提升的手段与验证方式。"
      },
      {
        id: "second-order-thinking",
        label: "二阶思维追问",
        template:
          "不要列一二三，直接用二阶思维看我刚才说的内容，先说直接后果，再说后果的后果，若有再补三阶效应。同时判断为什么更强玩家可能不进场，以及合规、品牌、长期成本上的隐性代价。"
      },
      {
        id: "inversion-premortem",
        label: "逆向思考/事前尸检",
        template:
          "不要列一二三，用逆向思考/事前尸检看我刚才说的内容，假设失败/亏损/关系破裂，最可能的原因是什么，早期预警信号有哪些，以及对应的预防与对冲手段。"
      },
      {
        id: "five-whys",
        label: "5 Whys 追问",
        template: "不要列一二三，沿着因果逐层追问我刚才说的内容直到根因，最终给出最可能的根因与可验证的方法。"
      },
      {
        id: "evidence-chain",
        label: "证据链验证",
        template:
          "不要列一二三，请对我刚才的结论做证据链验证，区分事实/观点/传言，说明每条需要哪些证据、来源可信度，以及证据不足时的替代验证方式。"
      },
      {
        id: "counterfactuals",
        label: "反事实推演",
        template:
          "不要列一二三，围绕我刚才的结论做反事实推演，说清关键条件改变时结果如何不同、影响路径、需要的数据/证据，以及对决策的影响。"
      },
      {
        id: "dig-deeper",
        label: "再深挖一层",
        template: "基于当前结果，再深挖一层看看。"
      }
    ]
  },
  {
